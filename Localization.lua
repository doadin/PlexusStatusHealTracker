...
local CURRENT_LOCALE = GetLocale() --luacheck: ignore 113
...
L["Shows in Grid who was healed by your multi-target heals."] = "Zeigt auf Grid die durch Eure Heilungszauber der mehrerer Ziele geheilt wurde." --luacheck: ignore 631
...
L["Shows in Grid who was healed by your multi-target heals."] = "Muestra en Grid que fue sanada por tus hechizos de curación de objetivos múltiples." --luacheck: ignore 631
...
L["Shows in Grid who was healed by your multi-target heals."] = "Montrer sur Grid qui avait été soigné par vos sorts de soins multi-cibles." --luacheck: ignore 631
...
L["Shows in Grid who was healed by your multi-target heals."] = "Mostra sulla Grid che è stato curato dalle tue incantesimi curative di obiettivi multipli." --luacheck: ignore 631
...
L["Shows in Grid who was healed by your multi-target heals."] = "Mostra no Grid que foi curado por seu feitiços de cura de múltiplos alvos." --luacheck: ignore 631
...
L["Shows in Grid who was healed by your multi-target heals."] = "Показывает в Grid, кто был вылечен Вашими АОЕ-заклинаниями" --luacheck: ignore 631
